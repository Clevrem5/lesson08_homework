...
class _HomePageTenState extends State<HomePageTen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF1C0F0D),
        title: const Padding(  // Appbbar chap tomon qismi
        ...
        actions: const [  // Appbar o'ng tomon qismi
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 15),
            child: Row(
              children: [
...
class YourRecipes extends StatelessWidget {
  ...
  final String image, svg, foodname, star, clock, min;
  final double count;
